      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-md w-full text-gray-500'>
        <div className='flex flex-col gap-1'>
          ...
          <input onChange={e => setCourseTitle(e.target.value)} value={courseTitle}
            type='text' placeholder='Type hear' className='outline-none md:py-2.5 py-3 px-3 rounded border border-gray-500' required />
        </div>
        <div className='flex flex-col gap-1 '>
        ...
        <div className='flex flex-col gap-1'>
          ...
          <input onChange={e => setDiscount(e.target.value)} value={discount} type="number"
            placeholder='0' min={0} max={100} className='outline-none md:py-2.5 py-2 w-28 px-3 rounded border border-gray-500' />
        </div>
        <div>
                  ...
                  {chapter.chapterContent.map((lecture, lectureIndex) => (
                    <div key={lectureIndex} className='flex justify-between items-center mb-2'>
                      <span>
                        ...
                        mins - <a href={lecture.lectureUrl} target='_blank' className='text-blue-500'>Link</a> - {lecture.isPreviewFree ? 'Free Preview' :
                          'Paid'}
                      </span>
        ...
        <button type='button' className='bg-black text-white w-max py-2.5 px-8 rounded my-4'>Add</button>
      </form>
    </div>
  )
}
