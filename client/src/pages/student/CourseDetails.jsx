  ...
  return courseData ? (
    ...
    <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
      ...
      <div className='absolute top-0 left-0 w-full h-section-height -z-1 bg-gradient-to-b from-cyan-100/70'>
         ...
         <div className='max-w-xl z-10 text-gray-500'>
          ...
          {/*  review and rating */}
           ...
           <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
                  ...
                  <p className='text-sm'>Course by <span className='text-blue-600 underline'>Sudharsan</span></p>
         ...
         {/* right column */}
         <div className='max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w0[300px] sm:min-w-[420px]'>
            ...
            <button className='md:mt-6 mt-4 w-full py-3 rounded bg-blue-600 text-white font-medium'>
              ...
              <div className='pt-6'>
                ...
                <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-gray-500'>
                  ...
                  <li>Downlodable resources and sourse code.</li>
                  <li>Quizzes to test your knowledge.</li>
                  <li>Certificate of complection.</li>
                </ul>
              </div>
          </div>
         </div>
